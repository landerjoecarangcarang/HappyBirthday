(function () {
  ...
  function showWish() {
    ...
    if (
      wishEl &&
      wishEl.classList.contains('show')
    ) {
      return;
    }
    ...
    document
      ...
      .textContent =
        'My dear cousin Jolan Keicel, ' +
        'may your year be filled with ' +
        'laughter, love, and may your ' +
